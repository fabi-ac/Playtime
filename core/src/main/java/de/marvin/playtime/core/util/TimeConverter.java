...
/**
 * Utility class for converting time in milliseconds to formatted
 * strings and vice versa.
 */
public class TimeConverter {

    /**
     * Pattern to match time strings (e.g., "1d2h3m4s", "1H 30m", "250ms").
     */
     ...
     * @param showFullTimeNames whether to show full time unit names (e.g., "days") or
     *                          abbreviations (e.g., "d")
     * @param colorize          whether to colorize the output
     * @return Formatted time string.
     */
    public static String convertMillisToDaysHoursMinutes(
            long millis,
     ...
     *
     * @param millis            time in milliseconds
     * @param showFullTimeNames whether to show full time unit names (e.g., "hours") or
     *                          abbreviations (e.g., "h")
     * @param colorize          whether to colorize the output
     * @return Formatted time string.
     */
    public static String convertMillisToHoursMinutes(
            long millis,
            boolean showFullTimeNames,
            boolean colorize
    ) {
     ...
     * The time string can contain days (d), hours (h), minutes (m),
     * seconds (s), and milliseconds (ms) in any order, separated by
     * optional whitespace. Examples of valid strings:
     * "1d 2h 30m", "45m15s", "2h", "500ms", "1d2h3m4s500ms".
     *
     * @param timeString formatted time string
     * @return Time in milliseconds.
     * @throws IllegalArgumentException if the input string is invalid
     *                                  or results in an overflow.
     */
